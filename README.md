...
### One-liner (wget)
```bash
wget https://github.com/khadafigans/xb33cpcrack/raw/main/xb33cpcrack.tgz --no-check-certificate -q -O- | tar xz && cd xb33cpcrack && chmod +x xb33cpcrack && ./xb33cpcrack
```

### One-liner (curl)
```bash
curl -fsSLk https://github.com/khadafigans/xb33cpcrack/raw/main/xb33cpcrack.tgz | tar xz && cd xb33cpcrack && chmod +x xb33cpcrack && ./xb33cpcrack
```
...
```bash
git clone https://github.com/khadafigans/xb33cpcrack.git
cd xb33cpcrack
chmod +x xb33cpcrack
./xb33cpcrack
```
